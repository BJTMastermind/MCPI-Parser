...
public class PiThrownEgg extends PiEntity {
    private byte inTile;
    ...
    public PiThrownEgg(float x, float y, float z) {
    ...
    public static PiThrownEgg fromCompoundTag(CompoundTag entityTag) {
        ...
        PiThrownEgg outEntity = new PiThrownEgg(pos.get(0).asFloat(), pos.get(1).asFloat(), pos.get(2).asFloat());
